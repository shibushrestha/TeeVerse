# Generated by Django 4.1.3 on 2023-04-01 10:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tshirt_type', models.CharField(choices=[('K', 'Kids'), ('A', 'Adults')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, upload_to='Myapp/User/profile_image/', verbose_name='profile image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product', models.ManyToManyField(through='Myapp.CartItem', to='Myapp.product', verbose_name='cart items')),
